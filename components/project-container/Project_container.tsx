...
const Project_container = ({
  ...
  return (
    <div className="w-full flex flex-col text-white/80 items-center justify-center gap-10 p-4 md:py-8">
      {/* Projects  container*/}
      <h1 className="font-extrabold text text-xl sm:text-2xl md:text-4xl">
        {project_no}
      </h1>
      <div className="w-full md:w-[80%]">
        <div className="w-full  h-auto border-4 bg-black/10 p-4 flex flex-col md:flex-row items-start justify-evenly gap-5 ">
        ...
        <div className="border-t border-b py-10 flex flex-col gap-4">
          <h1 className="flex flex-col gap-1 mt-5">
            ...
            <span className="text-justify font-light">{project_description}</span>
          </h1>
          <div className="w-full flex flexx-row items-center gap-5">
            <Link
              className="border-3 text-center  p-2 md:p-3 text- font-bold w-[50%] cursor-pointer"
              href="/projects"
            >
              Go to projects
            </Link>
