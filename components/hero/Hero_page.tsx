  ...
  return (
    <div className="relative w-full overflow-hidden">
      ...
      >
        ...
        >
          <h1
            className={`text-white fon-changa text-4xl md:text-6xl lg:text-7xl font-bold drop-shadow-lg ${changaOne.className}`}
          >
            Festus Phillip A.
          </h1>
      ...
      >
        ...
        <div className={`relative p-8 w-full mt-5 ${changaOne.className}`}>
          <motion.h2
            className="text-[4em] sm:text-[6em] md:text-[9em] lg:text-[14em] font- leading-none  text-[#49332a] font-style"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
          >
