...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <h1
        className="text-center font-extrabold text-3xl sm:text-24l md:text-6xl text-amber-950 mb-20"
      >
        PROJECTS
      </h1>

      <div className="bg-black/90 text-amber-50">
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-20 z-20 p-8 md:p-12">
